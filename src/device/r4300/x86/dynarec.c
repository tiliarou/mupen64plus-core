...
static void gencp0_update_count(struct r4300_core* r4300, unsigned int addr)
{
    ...
    add_m32_reg32((unsigned int*)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0)), EAX);
    mov_reg32_imm32(EAX, 0);
    adc_m32_reg32((unsigned int*)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0)+4), EAX);
#else
...
{
    mov_eax_memoffs32((unsigned int*)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0)+4));
...
{
    mov_reg32_m32(EBX, (unsigned int*)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0)+4));
...
static void gentest_idle(struct r4300_core* r4300)
{
    ...
    mov_reg32_m32(reg, (unsigned int *)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0)+4));
    test_reg32_reg32(reg, reg);
    jns_rj(32);

    //TODO: 64bit substraction?
    mov_reg32_m32(reg, (unsigned int *)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0))); //6
    sub_m32_reg32((unsigned int *)(&r4300_cp0_regs(&r4300->cp0)[CP0_COUNT_REG]), reg); // 6

    mov_m32_imm32((unsigned int *)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0)), 0); //10
    mov_m32_imm32((unsigned int *)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0)+4), 0); //10
...
void genj_idle(struct r4300_core* r4300)
{
    ...
    //TODO: 64bit substraction?
    mov_reg32_m32(EAX, (unsigned int *)((unsigned int)r4300_cp0_next_interrupt(&r4300->cp0))); //6
