...
{
  int r,hr;
  int preferred_reg = (tr&3)+(tr>28)*4-(tr==32)+2*(tr==36)-(tr==40);
...
static void alloc_x86_reg(struct regstat *cur,int i,signed char tr,int hr)
{
  int n;
  int dirty=0;
